...
public class BBSMod implements ModInitializer
{
    ...
    public static final GunItem GUN_ITEM = new GunItem(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(MOD_ID, "gun"))).maxCount(1));
    public static final BlockItem CHROMA_RED_BLOCK_ITEM = createChromaItem(CHROMA_RED_BLOCK, "chroma_red");
    public static final BlockItem CHROMA_GREEN_BLOCK_ITEM = createChromaItem(CHROMA_GREEN_BLOCK, "chroma_green");
    public static final BlockItem CHROMA_BLUE_BLOCK_ITEM = createChromaItem(CHROMA_BLUE_BLOCK, "chroma_blue");
    public static final BlockItem CHROMA_CYAN_BLOCK_ITEM = createChromaItem(CHROMA_CYAN_BLOCK, "chroma_cyan");
    public static final BlockItem CHROMA_MAGENTA_BLOCK_ITEM = createChromaItem(CHROMA_MAGENTA_BLOCK, "chroma_magenta");
    public static final BlockItem CHROMA_YELLOW_BLOCK_ITEM = createChromaItem(CHROMA_YELLOW_BLOCK, "chroma_yellow");
    public static final BlockItem CHROMA_BLACK_BLOCK_ITEM = createChromaItem(CHROMA_BLACK_BLOCK, "chroma_black");
    public static final BlockItem CHROMA_WHITE_BLOCK_ITEM = createChromaItem(CHROMA_WHITE_BLOCK, "chroma_white");
    ...
    private static BlockItem createChromaItem(Block block, String name)
    {
        return new BlockItem(block, new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(MOD_ID, name))));
    }
