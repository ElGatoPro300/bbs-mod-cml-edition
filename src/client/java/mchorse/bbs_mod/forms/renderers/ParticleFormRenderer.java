    ...
    public void render3D(FormRenderingContext context)
    {
        ...
        if (emitter != null)
        {
            ...
            if (!BBSRendering.isIrisShadowPass())
            {
                ...
                ShaderProgramKey shader = billboard
                    ? this.getShader(context, ShaderProgramKeys.RENDERTYPE_ITEM_ENTITY_TRANSLUCENT_CULL, BBSShaders.pickerBillboardKey) 
                : this.getShader(context, ShaderProgramKeys.PARTICLE, BBSShaders.pickerParticlesKey);
