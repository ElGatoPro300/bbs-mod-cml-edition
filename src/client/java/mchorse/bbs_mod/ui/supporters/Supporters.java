...
public class Supporters
{
    ...
    {
        return this.supporters.stream().filter(s -> s.name.equals("Discord") || s.name.equals("ElGatoPro300") || s.name.equals("seb024xd") || s.name.equals("Diobede") || s.name.equals("Fanyel") || s.name.equals("Mattux") || s.name.equals("bay4lly")) .sorted(Comparator.comparing((a) -> a.date)).collect(Collectors.toList());
    }

    public List<Supporter> getSpecialThanksSupporters()
    {
        return this.supporters.stream().filter(s -> s.name.equals("McHorse") || s.name.equals("Nioum") || s.name.equals("FunkyFight") || s.name.equals("Afegor (Alyokhin Dmitrii)") || s.name.equals("SIRSYP") || s.name.equals("Plixitizthz")).sorted(Comparator.comparing((a) -> a.date)).collect(Collectors.toList());
    }
}