...
public class Supporters
{
    ...
    {
        return this.supporters.stream().filter(Supporter::hasBanner).filter(s -> !s.name.equals("Discord") && !s.name.equals("ElGatoPro300") && !s.name.equals("seb024xd") && !s.name.equals("Diobede") && !s.name.equals("TobbyMC") && !s.name.equals("JaviCubito") && !s.name.equals("SEKZA_MC") && !s.name.equals("Jesuluto") && !s.name.equals("Kazu_MC") && !s.name.equals("SoyTon") && !s.name.equals("TheRocket") && !s.name.equals("AND_010") && !s.name.equals("Mattux") && !s.name.equals("SR400X") && !s.name.equals("MrJack") && !s.name.equals("Yeyo Sin Contexto") && !s.name.equals("Redbirdpro") && !s.name.equals("MiniSunn_") && !s.name.equals("lolinmalo") && !s.name.equals("ItzUkyo2013") && !s.name.equals("SoyFrann") && !s.name.equals("AymaWolf Omega") && !s.name.equals("Mokaccino") && !s.name.equals("itzPizzaXD") && !s.name.equals("Pirata_12") && !s.name.equals("Alabi Pictures") && !s.name.equals("McHorse") && !s.name.equals("Nioum") && !s.name.equals("FunkyFight") && !s.name.equals("Afegor (Alyokhin Dmitrii)")).sorted(Comparator.comparing((a) -> a.date)).collect(Collectors.toList());
    }

    public List<Supporter> getCMLSupporters()
    {
        return this.supporters.stream().filter(s -> s.name.equals("TobbyMC") || s.name.equals("JaviCubito") || s.name.equals("SEKZA_MC") || s.name.equals("Jesuluto") || s.name.equals("Kazu_MC") || s.name.equals("SoyTon") || s.name.equals("TheRocket") || s.name.equals("AND_010") || s.name.equals("SR400X") || s.name.equals("MrJack") || s.name.equals("Yeyo Sin Contexto") || s.name.equals("Redbirdpro") || s.name.equals("MiniSunn_") || s.name.equals("lolinmalo") || s.name.equals("ItzUkyo2013") || s.name.equals("SoyFrann") || s.name.equals("AymaWolf Omega") || s.name.equals("Mokaccino") || s.name.equals("itzPizzaXD") || s.name.equals("Pirata_12") || s.name.equals("Alabi Pictures")).sorted(Comparator.comparing((a) -> a.date)).collect(Collectors.toList());
    }

    public List<Supporter> getCMLDevelopers()
    {
        return this.supporters.stream().filter(s -> s.name.equals("Discord") || s.name.equals("ElGatoPro300") || s.name.equals("seb024xd") || s.name.equals("Diobede") || s.name.equals("Mattux")) .sorted(Comparator.comparing((a) -> a.date)).collect(Collectors.toList());
    }

    public List<Supporter> getSpecialThanksSupporters()
    {
        return this.supporters.stream().filter(s -> s.name.equals("McHorse") || s.name.equals("Nioum") || s.name.equals("FunkyFight") || s.name.equals("Afegor (Alyokhin Dmitrii)")).sorted(Comparator.comparing((a) -> a.date)).collect(Collectors.toList());
    }
}