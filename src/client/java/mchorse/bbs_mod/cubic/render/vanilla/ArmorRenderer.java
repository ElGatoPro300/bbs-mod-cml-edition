...
public class ArmorRenderer
{
    ...
    public void renderArmorSlot(MatrixStack matrices, VertexConsumerProvider vertexConsumers, IEntity entity, EquipmentSlot armorSlot, ArmorType type, int light)
    {
        ...
        {
            if (((net.minecraft.entity.LivingEntity)entity).getPreferredEquipmentSlot(itemStack) == armorSlot)
            {
    ...
    {
        String materialName = "leather";
        try {
             // materialName = item.getMaterial().value().assetId().getPath();
        } catch (Exception e) {}
